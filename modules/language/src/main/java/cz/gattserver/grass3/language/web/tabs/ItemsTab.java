...
import cz.gattserver.grass3.language.web.dialogs.LanguageItemDialog;
...
public class ItemsTab extends Div {
	...
	public ItemsTab(Long langId, ItemType type, LanguagePage languagePage) {
		...
		Column<LanguageItemTO> contentColumn = grid.addColumn(LanguageItemTO::getContent).setHeader("Obsah")
				.setSortProperty("content").setFlexGrow(100);
		Column<LanguageItemTO> translationColumn = grid.addColumn(LanguageItemTO::getTranslation)
				.setHeader(LanguagePage.PREKLAD_LABEL).setSortProperty("translation").setFlexGrow(100);
