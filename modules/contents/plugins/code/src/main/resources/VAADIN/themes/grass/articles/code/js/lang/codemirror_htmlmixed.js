 ...
 */
var codemirror_htmlmixed_timer = setInterval(function() {
	var elements = document.getElementsByName("codemirror_htmlmixed");
	if (elements.length > 0) {
		for (var i = 0; i < elements.length; i++) {
			codeMirrorConfig.mode = "text/html";
			CodeMirror.fromTextArea(elements[i], codeMirrorConfig);
		}
		clearInterval(codemirror_htmlmixed_timer);
	}
}, 100);