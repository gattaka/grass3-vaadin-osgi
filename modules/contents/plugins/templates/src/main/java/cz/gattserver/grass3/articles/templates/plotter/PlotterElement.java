	...
	public void apply(Context ctx) {
		...
		ctx.addJSCode(				
				 "$.plotter" + id + " = (function() {"
						...
						+ "		let secXAxisRoundedUnit = secXAxisUnit > 10 ? "
						+ "			Math.ceil(secXAxisUnit / 10) * 10 : "
						+ "			Math.ceil(secXAxisUnit);		"
						...
						+ "			ctx.fillText(axisNumber, cxZero + fontOffset, textY);"
						+ "		}"
						+ ""
						+ "		/* x osa grafu */"
						+ "		ctx.setLineDash([]);"
						...
						+ "		let secYAxisRoundedUnit = secYAxisUnit > 10 ?"
						+ "			Math.ceil(secYAxisUnit / 10) * 10 : "
						+ "			Math.ceil(secYAxisUnit);		"
						...
						+ "			ctx.stroke();		"
						+ "			ctx.textAlign = \"left\";"
						+ "			ctx.fillText(axisNumber, textX, cyZero - fontOffset);"
						+ "		}"
						+ "	"
						+ "		/* y osa grafu */"
						+ "		ctx.setLineDash([]);"
