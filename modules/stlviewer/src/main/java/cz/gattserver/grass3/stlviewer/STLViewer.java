package cz.gattserver.grass3.stlviewer;
...
public class STLViewer extends Div {
	...
	public void show(String url) {
		...
		if (!stlViewerInitialized) {
			String relativePath = UIUtils.getContextPath() + "/frontend/" + JS_PATH;
			js = STL_VIEWER_INSTANCE_JS_VAR + " = new StlViewer(document.getElementById(\"" + getId()
